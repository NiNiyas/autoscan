    ...
    if config['ENABLE_JOE']:
        ...
        try:
            ...
            try:
                ...
                if server_type == "jellyfin":
                    jellyfin_logger.error(f"Error occurred when trying to send scan request to Jellyfin. {e}")
                elif server_type == "emby":
                    emby_logger.error(f"Error occurred when trying to send scan request to Emby. {e}")
                pass
        except KeyError:
            pass
